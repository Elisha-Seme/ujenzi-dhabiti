...
(async () => {
  const src = "../Logo Updated-81.jpg.jpeg";
  ...
  const meta = await sharp("public/logo-horizontal-white.png").metadata();
  console.log("written logo-horizontal-white.png", meta.width + "x" + meta.height);
})();
