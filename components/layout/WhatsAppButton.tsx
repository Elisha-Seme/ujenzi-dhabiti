...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 pl-3 pr-4 py-3 group"
    >
