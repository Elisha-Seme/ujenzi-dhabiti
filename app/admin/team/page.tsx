...
const FIELDS: FieldDef[] = [
  ...
  { name: "bio", label: "Short Bio", type: "textarea", help: "Use approved professional information only." },
  { name: "competences", label: "Key Competences", type: "tags", help: "Comma-separated skills, disciplines, or certifications." },
