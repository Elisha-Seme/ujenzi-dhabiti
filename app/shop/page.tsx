...
const INFO_ITEMS = [
  ...
  { icon: <ClipboardList size={28} className="text-ud-burgundy mx-auto mb-3" />, title: "Pay & Receive", body: "Add items to cart, pay via M-Pesa or card, and we dispatch directly to your site." },
  ...
  const filtered = useMemo(() => {
    ...
    let results = allProducts.filter((p) => {
      ...
      if (search.trim()) {
        ...
        const haystack = `${p.name} ${p.category} ${p.description} ${specText}`.toLowerCase();
        ...
        <div className="max-w-content mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-5">
            <div className="relative flex-1">
              ...
              <input
                type="search"
                placeholder="Search by name, material, or spec…"
                value={rawSearch}
