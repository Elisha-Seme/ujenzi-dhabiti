              ...
              <div className="px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    href={`/track/${order.id}`}
                    target="_blank"
                    className="p-1.5 text-gray-400 hover:text-ud-burgundy transition-colors"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-md shadow-xl w-full max-w-md">
            ...
            <div className="px-6 py-5">
              ...
              <label className="block text-xs font-semibold text-gray-600 mb-1">Courier Tracking Number (optional)</label>
              <input
                value={trackingInput}
              ...
              />
              <p className="text-xs text-gray-400 mt-1.5">This will be visible to the buyer on the tracking page.</p>
            </div>
